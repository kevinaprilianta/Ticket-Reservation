...
public class tampilanhasiledit extends JFrame{
    ...
    public tampilanhasiledit() {
        ...
        Class.forName("com.mysql.jdbc.Driver");
            ...
            JOptionPane.showMessageDialog(null, "DATA GAGAL DITAMPILKAN", "DATA PEMESANAN TIKET KERETA API LOKAL", JOptionPane.ERROR_MESSAGE);
        }
        catch (ClassNotFoundException ex) {
            JOptionPane.showMessageDialog(null, "DRIVER TIDAK DITEMUKAN", "DATA PEMESANAN TIKET KERETA API LOKAL", JOptionPane.ERROR_MESSAGE);
        }
