...
public class inputjadwaljoglokerto {
    public static void main(String[] args) {
        input2 m = new input2();
    }
}

class input2 extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        {   
            try {
                    ...
                    statement.executeUpdate("insert into jadwal_joglokerto values('"+ tfjam.getText() + "');");
